...
@section('body')
    <aside id="colorlib-hero">
        <div class="flexslider">
            <ul class="slides">
                <li style="background-image: url({{ asset('images/cover-img-2.jpg') }});">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="wrap-division">
                        ...
                        <article class="animate-box">
                            <div class="blog-img" style="background-image: url({{ asset('images/blog-3.jpg') }});"></div>
                            <div class="desc">
                                <div class="meta">
                                    <p>
                                        <span>Feb 24, 2018 </span>
                        ...
                        <div class="side animate-box">
                            ...
                            <div class="blog-entry-side">
                                <a href="blog.html" class="blog-post">
                                    <span class="img" style="background-image: url({{ asset('images/blog-3.jpg') }});"></span>
                                    <div class="desc">
